...
db.airlines.createIndex( { Origin: 1, Year: 1 } )
EOF

# Managing Mongo Indexes
# https://docs.mongodb.com/manual/tutorial/manage-indexes/
# Get ALL indexes for airlines collection
# db.airlines.getIndexes()
# Drop Index
# db.airlines.dropIndexes()
# db.airlines.aggregate( [ { $indexStats: { } } ] )
